...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "View, create, or edit files in the virtual file system. Use 'create' to make new files, 'str_replace' to edit existing files, 'view' to read files, and 'insert' to add lines.",
